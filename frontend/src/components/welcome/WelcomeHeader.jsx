  ...
  return (
    <>
      ...
      >
        ...
        <span
          className="text-gray-800 text-xs md:text-sm font-medium truncate"
          style={{
            maxWidth: '70%', // prevent it from pushing icons
            whiteSpace: 'nowrap',
            overflow: 'hidden',
        ...
        >
          Dalit Resources for Education and Economics Advanced and Mobilization Society (DREAMS)
        </span>
      ...
      {/* Main Header - Updated to 70px height */}
      <header
        ...
        style={{
          ...
          position: 'relative',
          zIndex: 20,
          background: '#7AA896', // Dark professional blue color
          height: '75px', // Updated to 70px
          display: 'flex',
          alignItems: 'center',
        }}
      >
        ...
        <div className="w-full flex flex-row items-center justify-between gap-2 md:gap-4 relative z-30"
          ...
          <div
            ...
            style={{ alignItems: 'center' }}
          >
            {/* Logo Image - Using a demo logo from placeholder.com */}
            <div
              className="flex items-center justify-center flex-shrink-0"
              style={{ minWidth: 'fit-content' }}
            >
              <img
                src="/partners.png" // ✅ Correct public path
                alt="Community Logo"
                style={{
                  height: 36,
                  width: 36,
            ...
            >
              <span
                className="brand-text font-bold tracking-tight truncate"
                style={{
                  fontFamily: logoFont,
                  fontSize: '22px',
                  letterSpacing: '-0.6px',
          ...
          <div className="hidden md:flex flex-1 items-center justify-between" style={{ alignItems: 'center' }}>
            ...
            <div className="flex gap-3 md:gap-4 min-w-fit justify-center md:justify-end">
              ...
              <button
                ...
                className="p-2 text-white/90 hover:text-white/100 hover:bg-white/08 rounded-lg transition-all duration-300"
                title="Global Search"
              >
              ...
              <Link to="/login">
                <Button
                  className="professional-button bg-white/95 backdrop-blur-sm border border-white/20 text-[#2c3e50] font-semibold px-5 md:px-6 py-2 rounded-lg shadow-sm hover:bg-white/100 hover:scale-102 transition-all duration-300 text-sm md:text-[15px]"
              ...
              <Link to="/register">
                <Button
                  className="professional-button bg-[#3498db] text-white font-semibold px-5 md:px-6 py-2 rounded-lg hover:bg-[#2980b9] hover:scale-102 transition-all duration-300 text-sm md:text-[15px] border-0 shadow-sm"
                  style={{ fontFamily: headerFont, letterSpacing: '0.025em' }}
                >
                  Register
                </Button>
          ...
          <div className="md:hidden flex-shrink-0 flex items-center gap-2">
            ...
            <button
              onClick={() => setSearchOpen(true)}
              className="p-2 text-white/95 hover:text-white/100 hover:bg-white/08 rounded-lg transition-all duration-300"
              title="Global Search"
            >
              <Search className="w-5 h-5" />
            </button>
                ...
                <div className="flex flex-col gap-6 p-4 md:p-6 h-full overflow-y-auto">
                  <div className="flex flex-row items-center gap-3 mb-6">
                    ...
                    <div className="flex flex-col">
                      <span className="brand-text font-bold text-base md:text-lg leading-tight text-gray-800">UNITY</span>
                  ...
                  <div className="flex flex-col gap-3 mt-auto pt-6 border-t border-gray-200">
                    ...
                    <Link to="/register" onClick={() => setMenuOpen(false)}>
                      <button className="professional-button w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-lg px-4 py-2.5 hover:from-blue-700 hover:to-cyan-700 hover:scale-105 hover:shadow-md transition-all duration-300 text-sm md:text-base shadow-md touch-manipulation">
                        Register
                      </button>
                    </Link>
                  </div>
